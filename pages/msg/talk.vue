	...
	<view class="talk">
		<view class="talkLis">
			<view class="talkli talkU">
				<view class="talkHead"><img src="../../static/images/pic/header.png" alt="" class="xd-list-head-img " /></view>
				<view class="talkInfo">
		...
		<view class="talkInput">
			<form action="">
				<input class="uni-input" focus placeholder="点击输入内容" />
			</form>
		</view>
	</view>
</template>
