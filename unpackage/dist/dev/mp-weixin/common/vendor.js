...
serverBaseUrl + '/room/quitByUserId'), _defineProperty(_serverUrls, "xd_selectSHInfo",

serverBaseUrl + '/Activity/select'), _defineProperty(_serverUrls, "xd_baseSelectSHInfo",
serverBaseUrl + '/Activity/baseSelect'), _defineProperty(_serverUrls, "xd_updateSHInfo",
serverBaseUrl + '/Activity/update'), _defineProperty(_serverUrls, "xd_baseUpdateSHInfo",
serverBaseUrl + '/Activity/baseUpdate'), _defineProperty(_serverUrls, "xd_saveSHInfo",
serverBaseUrl + '/Activity/save'), _defineProperty(_serverUrls, "xd_baseSaveSHInfo",
serverBaseUrl + '/Activity/baseSave'), _defineProperty(_serverUrls, "xd_selectSHList",
serverBaseUrl + '/Activity/selectList'), _defineProperty(_serverUrls, "xd_joinActivity",
serverBaseUrl + '/Activity/joinActivity'), _defineProperty(_serverUrls, "xd_joinActivityUserList",
...
function xd_onShare(title, path, imageUrl) {
  ...
  var defaultImageUrl = this.xd_randomImg(1);
...

{
  ...
  xd_showToastNew: xd_showToastNew,
